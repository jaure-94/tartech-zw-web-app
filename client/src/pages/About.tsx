  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-industrial-black via-gray-900 to-industrial-black overflow-hidden">
        ...
        {/* Main Content */}
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-20 md:pb-24 lg:pb-28">
              ...
              <div className="space-y-4">
                <div className="animate-slide-up-delay-1">
                  <div className="inline-flex items-center px-3 py-1.5 md:px-4 md:py-2 bg-construction-yellow/20 backdrop-blur-sm rounded-full border border-construction-yellow/30 mb-4 md:mb-6">
                    <span className="text-construction-yellow text-xs sm:text-sm font-bold tracking-wider">TARTECH CONTRACTING</span>
            ...
            <div className="animate-slide-in-left">
              <Card className="h-full text-center p-4 md:p-6 lg:p-8 border-4 border-transparent hover:border-construction-yellow transition-all duration-500 shadow-xl">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-industrial-black mb-3 md:mb-4">SAFETY</h3>
                  <div className="space-y-1 md:space-y-2 text-industrial-gray">
                    <p className="font-semibold text-sm md:text-base">HEALTH</p>
                    <p className="font-semibold text-sm md:text-base">QUALITY</p>
                    <p className="font-semibold text-sm md:text-base">ENVIRONMENT</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-slide-in-left">
              <Card className="h-full text-center p-4 md:p-6 lg:p-8 border-4 border-transparent hover:border-construction-yellow transition-all duration-500 shadow-xl">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-industrial-black mb-3 md:mb-4">INTEGRITY</h3>
                  <div className="space-y-1 md:space-y-2 text-industrial-gray">
                    <p className="font-semibold text-sm md:text-base">HONESTY</p>
                    <p className="font-semibold text-sm md:text-base">RESPONSIBILITY</p>
                    <p className="font-semibold text-sm md:text-base">ACCOUNTABILITY</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-slide-in-right">
              <Card className="h-full text-center p-4 md:p-6 lg:p-8 border-4 border-transparent hover:border-construction-yellow transition-all duration-500 shadow-xl">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-industrial-black mb-3 md:mb-4">PEOPLE</h3>
                  <div className="space-y-1 md:space-y-2 text-industrial-gray">
                    <p className="font-semibold text-sm md:text-base">COLLABORATION</p>
                    <p className="font-semibold text-sm md:text-base">DEVELOPMENT</p>
                    <p className="font-semibold text-sm md:text-base">OPPORTUNITY</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-slide-in-right">
              <Card className="h-full text-center p-4 md:p-6 lg:p-8 border-4 border-transparent hover:border-construction-yellow transition-all duration-500 shadow-xl">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-industrial-black mb-3 md:mb-4">INNOVATION</h3>
                  <div className="space-y-1 md:space-y-2 text-industrial-gray">
                    <p className="font-semibold text-sm md:text-base">INSPIRE</p>
                    <p className="font-semibold text-sm md:text-base">EVOLVE</p>
                    <p className="font-semibold text-sm md:text-base">IMPROVE</p>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-light-industrial">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            ...
            <div className="animate-slide-in-right">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-industrial-black mb-6 md:mb-8">TRUSTED BY LEADING ORGANIZATIONS</h3>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">City of Harare</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Municipal Infrastructure</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <Building2 className="h-5 w-5 md:h-6 md:w-6 text-construction-yellow flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">City of Marondera</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Urban Development</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Bikita Minerals</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Mining Infrastructure</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Min of Transport</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Department of Roads</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <Settings className="h-5 w-5 md:h-6 md:w-6 text-construction-yellow flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Freda Rebecca Mines</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Gold Mining Operations</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <Settings className="h-5 w-5 md:h-6 md:w-6 text-construction-yellow flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Bindura Nickel Corporation</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Nickel Mining</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <Building2 className="h-5 w-5 md:h-6 md:w-6 text-construction-yellow flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Khaya Cement</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Industrial Manufacturing</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="p-4 md:p-6 bg-white border-l-4 border-construction-yellow shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <Settings className="h-5 w-5 md:h-6 md:w-6 text-construction-yellow flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-sm md:text-base text-industrial-black">Zimplats</h4>
                        <p className="text-xs md:text-sm text-industrial-gray">Platinum Mining</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 text-center hover:border-construction-yellow transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-white font-bold mb-2 text-sm md:text-base">ZBCA</h3>
                  <p className="text-gray-300 text-xs md:text-sm">Zimbabwe Building Contractors Association</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 text-center hover:border-construction-yellow transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-white font-bold mb-2 text-sm md:text-base">PRAZ</h3>
                  <p className="text-gray-300 text-xs md:text-sm">Procurement Regulatory Authority</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 text-center hover:border-construction-yellow transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-white font-bold mb-2 text-sm md:text-base">NEC</h3>
                  <p className="text-gray-300 text-xs md:text-sm">National Employment Council for Construction</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 text-center hover:border-construction-yellow transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-white font-bold mb-2 text-sm md:text-base">CIFOZ</h3>
                  <p className="text-gray-300 text-xs md:text-sm">Construction Industry Federation of Zimbabwe</p>
                </CardContent>
              </Card>
            </div>
          </div>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 text-center hover:border-construction-yellow transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-white font-bold mb-2 text-sm md:text-base">NSSA</h3>
                  <p className="text-gray-300 text-xs md:text-sm">National Social Security Authority</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="animate-fade-in">
              <Card className="bg-white/5 backdrop-blur-md border border-construction-yellow/30 p-4 md:p-6 text-center">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-400 text-xs md:text-sm">Licensed and compliant with government construction standards</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-construction-yellow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="animate-fade-in flex justify-center">
            <Button size="lg" className="bg-industrial-black text-construction-yellow hover:bg-gray-800 text-base md:text-lg px-6 md:px-8 py-3 md:py-4">
